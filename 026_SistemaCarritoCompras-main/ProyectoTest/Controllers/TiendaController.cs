...
namespace ProyectoTest.Controllers
{
    public class TiendaController : Controller
    {
        ...
        [HttpPost]
        public JsonResult ObtenerMunicipio(string _IdDepartamento)
        {
            List<Municipio> oLista = new List<Municipio>();
            oLista = UbigeoLogica.Instancia.ObtenerMunicipio(_IdDepartamento);
            return Json(new { lista = oLista }, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public JsonResult ObtenerDistrito(string _IdMunicipio,string _IdDepartamento)
        {
            List<Distrito> oLista = new List<Distrito>();
            oLista = UbigeoLogica.Instancia.ObtenerDistrito(_IdMunicipio,_IdDepartamento);
            return Json(new { lista = oLista }, JsonRequestBehavior.AllowGet);
        }
